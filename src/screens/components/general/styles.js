...
const sG = EStyleSheet.create({
  ...
  bg_green_light: { backgroundColor: '$colorGreenLight' },
  ...
  brounded_top_left_max: {
    borderTopLeftRadius: "200rem",
  },
  brounded_top_right_max: {
    borderTopRightRadius: "200rem",
  },
  brounded_bottom_left_max: {
    borderBottomLeftRadius: "200rem",
  },
  brounded_bottom_right_max: {
    borderBottomRightRadius: "200rem",
  },
  ...
  size_icon: {fontSize: '25rem'},
  size_icon_xs: {fontSize: '15rem'},
  size_icon_md: {fontSize: '60rem'},
  size_icon_lg: {fontSize: '20rem'},
  size_icon_ls: {fontSize: '40rem'},
  size_icon_xl: {fontSize: '100rem'},
